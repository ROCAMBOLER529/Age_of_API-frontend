...
const ModifyResOfTechLink = stats => {
    ...
    const llamadaAlPut = async () => {
        try {
            ...
            const res = await fetch(`https://age-of-api-backend.onrender.com/api/tech/updateResearchOfTech/${name}`, {
                method: 'PUT',
                headers: {
...
export default ModifyResOfTechLink;
